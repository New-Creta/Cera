...
#include "resources/raster_state.h"
    ...
    namespace renderer
    {
        namespace conversions
        {
            ...
            D3D12_RESOURCE_DIMENSION to_RESOURCE_DIMENSION(ResourceDimension dimension)
            {
                switch (dimension)
                {
                case ResourceDimension::DIMENSION_UNKNOWN:
                    return D3D12_RESOURCE_DIMENSION_UNKNOWN;
                case ResourceDimension::DIMENSION_BUFFER:
                    return D3D12_RESOURCE_DIMENSION_BUFFER;
                case ResourceDimension::DIMENSION_TEXTURE1D:
                    return D3D12_RESOURCE_DIMENSION_TEXTURE1D;
                case ResourceDimension::DIMENSION_TEXTURE2D:
                    return D3D12_RESOURCE_DIMENSION_TEXTURE2D;
                case ResourceDimension::DIMENSION_TEXTURE3D:
                    return D3D12_RESOURCE_DIMENSION_TEXTURE3D;
                }

                CERA_ASSERT("Unsupported resource dimension given");
                return D3D12_RESOURCE_DIMENSION_UNKNOWN;
            }
            ...
            D3D12_TEXTURE_LAYOUT to_TEXTURE_LAYOUT(TextureLayout textureLayout)
            {
                ...
                {
                case TextureLayout::TEXTURE_LAYOUT_64KB_STANDARD_SWIZZLE:
                    return D3D12_TEXTURE_LAYOUT_64KB_STANDARD_SWIZZLE;
                case TextureLayout::TEXTURE_LAYOUT_64KB_UNDEFINED_SWIZZLE:
                    return D3D12_TEXTURE_LAYOUT_64KB_UNDEFINED_SWIZZLE;
                case TextureLayout::TEXTURE_LAYOUT_ROW_MAJOR:
                    return D3D12_TEXTURE_LAYOUT_ROW_MAJOR;
                case TextureLayout::TEXTURE_LAYOUT_UNKNOWN:
                    return D3D12_TEXTURE_LAYOUT_UNKNOWN;
                }

                CERA_ASSERT("Unsupported texture layout given");
                return D3D12_TEXTURE_LAYOUT_UNKNOWN;
            }
            ...
            D3D12_FILL_MODE to_FILL_MODE(FillMode mode)
            {
                ...
                CERA_ASSERT("Unsupported fill mode given");
                return D3D12_FILL_MODE_SOLID;
            }
            ...
            D3D12_CULL_MODE to_CULL_MODE(CullMode mode)
            {
                ...
                CERA_ASSERT("Unsupported cull mode given");
                return D3D12_CULL_MODE_NONE;
            }
            ...
            D3D12_CONSERVATIVE_RASTERIZATION_MODE to_CONSERVATIVE_RASTERIZATION_MODE(ConservativeRasterizationMode mode)
            {
                switch (mode)
                {
                case ConservativeRasterizationMode::MODE_OFF:
                    return D3D12_CONSERVATIVE_RASTERIZATION_MODE_OFF;
                case ConservativeRasterizationMode::MODE_ON:
                    return D3D12_CONSERVATIVE_RASTERIZATION_MODE_ON;
                default:
                    break;
                }

                CERA_ASSERT("Unsupported conservative rasterization mode given");
                return D3D12_CONSERVATIVE_RASTERIZATION_MODE_OFF;
            }
            ...
            D3D12_PRIMITIVE_TOPOLOGY to_PRIMITIVE_TOPOLOGY(PrimitiveTopology topology)
            {
                ...
                CERA_ASSERT("Unsupported primitive topology given");
              ...
              public:
                ...
                std::shared_ptr<CommandList> command_list_for_backbuffer_index(D3D12_COMMAND_LIST_TYPE type, s32 index)
                {
                    ...
                    case D3D12_COMMAND_LIST_TYPE_COMPUTE:
                        return m_compute_active_command_lists[index];
                    case D3D12_COMMAND_LIST_TYPE_COPY:
                        return m_copy_active_command_lists[index];
                    case D3D12_COMMAND_LIST_TYPE_DIRECT:
                        return m_direct_active_command_lists[index];
                    }

                    CERA_ASSERT("Invalid CommandListType given");
                    return nullptr;
                }
