    ...
    namespace renderer
    {
        ...
        public:
            ...
            */
             ...
             */
            wrl::com_ptr<ID3D12GraphicsCommandList2> graphics_command_list() const;
            ...
            void transition_barrier(wrl::com_ptr<ID3D12Resource> resource, D3D12_RESOURCE_STATES stateAfter, u32 subresource = D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES, bool flushBarriers = false);
            ...
            void copy_resource(wrl::com_ptr<ID3D12Resource> dstRes, wrl::com_ptr<ID3D12Resource> srcRes);
        ...
        protected:
            ...
            CommandList(d3d12_device& device, D3D12_COMMAND_LIST_TYPE type);
            virtual ~CommandList();
        ...
        private:
            void track_resource(wrl::com_ptr<ID3D12Object> object);
            ...
            wrl::com_ptr<ID3D12Resource> copy_buffer(memory_size bufferSize, const void* bufferData, D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE);

            // Binds the current descriptor heaps to the command list.
            void bind_descriptor_heaps();

            using TrackedObjects = std::vector <wrl::com_ptr<ID3D12Object> >;
            ...
            wrl::com_ptr<ID3D12GraphicsCommandList2> m_d3d_command_list;
            wrl::com_ptr<ID3D12CommandAllocator> m_d3d_command_allocator;
