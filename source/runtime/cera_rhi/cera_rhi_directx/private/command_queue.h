...
namespace cera
{
  namespace renderer
  {
    ...
    public:
      ...
      wrl::com_ptr<ID3D12CommandQueue> d3d_command_queue() const;
    ...
    protected:
      ...
      CommandQueue(d3d12_device& device, D3D12_COMMAND_LIST_TYPE type);
    ...
    private:
      ...
      {
        u64 fence_value;
        wrl::com_ptr<ID3D12CommandAllocator> command_allocator;
      };
      ...
      wrl::com_ptr<ID3D12CommandQueue> m_d3d_command_queue;
      wrl::com_ptr<ID3D12Fence> m_d3d_fence;
      u64 m_fence_value;
