...
namespace cera
{
  namespace renderer
  {
    ...
    //-------------------------------------------------------------------------
    void set_viewports(const std::vector<Viewport>& viewports)
    {
    ...
    //-------------------------------------------------------------------------
    void set_scissor_rects(const std::vector<ScissorRect>& scissorRects)
    {
