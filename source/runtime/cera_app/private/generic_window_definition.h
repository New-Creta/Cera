...
namespace cera
{
    ...
    public:
        ...
        generic_window_definition_builder& set_has_os_window_border(bool has_border);
        ...
        generic_window_definition_builder& set_has_close_button(bool has_close);
        ...
        generic_window_definition_builder& set_is_modal_window(bool is_modal);
        generic_window_definition_builder& set_is_regular_window(bool is_regular);
        generic_window_definition_builder& set_has_sizing_frame(bool has_sizing_frame);
        generic_window_definition_builder& set_preserve_aspect_ratio(bool preserve);
        generic_window_definition_builder& set_expected_max_width(s32 max_width);
        generic_window_definition_builder& set_expected_max_height(s32 max_height);
        ...
        generic_window_definition_builder& set_corner_radius(s32 corner_radius);
