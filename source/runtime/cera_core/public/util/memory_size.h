...
constexpr cera::memory_size operator"" _bytes(unsigned long long bytes)
{
    return cera::memory_size((s64)bytes);
}
constexpr cera::memory_size operator"" _kb(unsigned long long bytes)
{
    return cera::memory_size((s64)bytes * cera::KiloByteMultiple);
}
constexpr cera::memory_size operator"" _mb(unsigned long long bytes)
{
    return cera::memory_size((s64)bytes * cera::MegaByteMultiple);
}
constexpr cera::memory_size operator"" _gb(unsigned long long bytes)
{
    return cera::memory_size((s64)bytes * cera::GigaByteMultiple);
}

constexpr cera::memory_size operator"" _kib(unsigned long long bytes)
{
    return cera::memory_size((s64)bytes * cera::KibiByteMultiple);
}
constexpr cera::memory_size operator"" _mib(unsigned long long bytes)
{
    return cera::memory_size((s64)bytes * cera::MibiByteMultiple);
}
constexpr cera::memory_size operator"" _gib(unsigned long long bytes)
{
    return cera::memory_size((s64)bytes * cera::GibiByteMultiple);
}