...
namespace cera
{
    ...
    descriptor_allocation::descriptor_allocation(D3D12_CPU_DESCRIPTOR_HANDLE descriptor, u32 numHandles, u32 descriptorSize, std::shared_ptr<descriptor_allocator_page> page)
